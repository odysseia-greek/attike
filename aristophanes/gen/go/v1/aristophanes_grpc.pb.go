...
func (c *traceServiceClient) HealthCheck(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/aristophanes.v1.TraceService/HealthCheck", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *traceServiceClient) Chorus(ctx context.Context, opts ...grpc.CallOption) (TraceService_ChorusClient, error) {
	stream, err := c.cc.NewStream(ctx, &TraceService_ServiceDesc.Streams[0], "/aristophanes.v1.TraceService/Chorus", opts...)
	if err != nil {
		return nil, err
	}
...
type TraceService_ChorusClient interface {
	...
	CloseAndRecv() (*ObserveResponse, error)
	grpc.ClientStream
}
...
func (x *traceServiceChorusClient) Send(m *ObserveRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *traceServiceChorusClient) CloseAndRecv() (*ObserveResponse, error) {
...
func _TraceService_HealthCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aristophanes.v1.TraceService/HealthCheck",
	}
...
type TraceService_ChorusServer interface {
	SendAndClose(*ObserveResponse) error
...
func (x *traceServiceChorusServer) SendAndClose(m *ObserveResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *traceServiceChorusServer) Recv() (*ObserveRequest, error) {
...
var TraceService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "aristophanes.v1.TraceService",
	...
	Metadata: "v1/aristophanes.proto",
}
