...
|__|__||__|\_||____|\___|  |__|   \___/ |__|  |__|__||__|__||__|__||_____| \___|
	...
	aristophanesConf, err := config.CreateNewConfig(env)
	if err != nil {
	...
	tracingServer := &app.AristophanesHandler{
		Config: aristophanesConf,
	}

	pb.RegisterTraceServiceServer(server, tracingServer)
